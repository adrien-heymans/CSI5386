...
def get_questions_from_csv():
    df = pd.read_csv("/content/drive/MyDrive/CSI5386-Assignment_2/evalutation/github-code/category_descriptions.csv")
    q_dict = {}
...
def get_results(model_path, gt_dict, verbose=False):
    ...
    arr = []
    for i in range(100):
        prec_at_recall, _ = get_prec_at_recall(precisions, recalls, confs, recall_thresh=(i/100))
        arr.append(prec_at_recall)
    print(arr)
...
if __name__ == "__main__":
    # test_json_path = "./data/test copy.json"
    # model_path = "./trained_models/deberta-v2-xlarge"
    print("Results for RoBERTa - Base : ")
    test_json_path = "/content/drive/MyDrive/CSI5386-Assignment_2/data/test roberta.json"
    model_path = "/content/drive/MyDrive/CSI5386-Assignment_2/trained-models/roberta-base-CUAD"
    save_dir = "./results"
    ...
    test_json_path = "/content/drive/MyDrive/CSI5386-Assignment_2/data/test bert.json"
    model_path = "/content/drive/MyDrive/CSI5386-Assignment_2/trained-models/bert-CUAD"
    save_dir = "./results"
    if not os.path.exists(save_dir): os.mkdir(save_dir)
    ...
    test_json_path = "/content/drive/MyDrive/CSI5386-Assignment_2/data/test legal-bert.json"
    model_path = "/content/drive/MyDrive/CSI5386-Assignment_2/trained-models/legal-bert-CUAD"
    save_dir = "./results"
    if not os.path.exists(save_dir): os.mkdir(save_dir)
